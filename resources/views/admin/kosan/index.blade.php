...
<head>
    ...
    <title>Kelola Kosan - Koztly</title>
...
<body class="bg-gray-50">
    ...
    <aside id="sidebar" class="fixed left-0 top-0 z-40 w-64 h-screen bg-white shadow-lg sidebar-bg">
        <div class="h-full px-3 py-4 overflow-y-auto relative">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.kosan.index') }}" class="flex items-center p-3 text-white bg-pink-500 rounded-lg hover:bg-pink-600 transition">
    ...
    <div id="main-content" class="ml-64 transition-all duration-300">
        ...
        <nav class="bg-blue-300 shadow-md fixed top-0 z-20 right-0 left-64 transition-all duration-300" id="navbar">
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <h2 class="text-xl font-semibold text-white">Kelola Kosan</h2>
        ...
        <main class="mt-20 p-6">
            ...
            <!-- Filter -->
            <form action="{{ route('admin.kosan.index') }}" method="GET" class="bg-white p-6 rounded-2xl shadow mb-6">
