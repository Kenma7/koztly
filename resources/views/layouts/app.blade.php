...
<body class="bg-white text-gray-900 sidebar-transitioning">
    ...
    <main class="pt-12 flex relative z-20">
        <!-- Sidebar -->
        ...
        <!-- Main Content -->
        <div class="main-content flex-1 ml-64 transition-all duration-300 relative z-10">
    ...
    <div
        class="alert-auto-close fixed top-20 right-4 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 max-w-sm">
        ✅ {{ Session::get('success') }}
    </div>
    @endif
    ...
    <div
        class="alert-auto-close fixed top-20 right-4 bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 max-w-sm">
        ❌ {{ Session::get('error') }}
    </div>
    @endif
    ...
    <div
        class="alert-auto-close fixed top-20 right-4 bg-yellow-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 max-w-sm">
    ...
    @if(Session::has('info'))
    <div
        class="alert-auto-close fixed top-20 right-4 bg-blue-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 max-w-sm">
        ℹ️ {{ Session::get('info') }}
    </div>
    @endif
    ...
    <script>
        // SINGLE DOMContentLoaded untuk semua functionality
        document.addEventListener('DOMContentLoaded', function() {
            console.log('=== KOZTLY APP INITIALIZED ===');
            ...
            if (profileBtn && profileDropdown) {
                ...
                profileBtn.addEventListener('click', function(e) {
                    ...
                    console.log('Dropdown visible:', !isHidden);
                });
            ...
            // 2. LOVE BUTTONS HANDLER
            const loveButtons = document.querySelectorAll('.love-btn');
            console.log('Found love buttons:', loveButtons.length);
            ...
            loveButtons.forEach(btn => {
                btn.addEventListener('click', function(e) {
                    ...
                    if (icon.classList.contains('text-gray-200')) {
            ...
            // 3. NOTIFICATION SYSTEM (existing code)
            console.log('Notification system initialized');
            if (window.sweetSuccess) {
                Swal.fire({
                    icon: 'success',
